...
public class Board {
    ...
    private void putDoorOnBoard(String keyIdNeeded) {
        List<Coordinates> doorCoords = new ArrayList<>();
        doorCoords.add(new Coordinates(4, 2));
        door = new Door(doorCoords, keyIdNeeded);
        boardList.add(door);
    }
